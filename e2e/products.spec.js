...
describe('PUT /products/:productid', () => {
  ...
  it('should fail with 400 when bad props', () => (
    fetchAsAdmin('/products', {
      method: 'POST', body: { name: 'Test', price: 10,
        //image: "https://github.com/Laboratoria/bootcamp/tree/main/projects/04-burger-queen-api/resources/images/water.jpg",
        type: "Lunch"
      },
    })
  ...
  it('should update product as admin', () => (
    fetchAsAdmin('/products', {
      method: 'POST',
      body: { name: 'Test', price: 10, type: "Lunch" },
    })
      .then((resp) => {
        expect(resp.status).toBe(200);
        return resp.json();
...
describe('DELETE /products/:productid', () => {
  ...
  it('should delete other product as admin', () => (
    fetchAsAdmin('/products', { method: 'POST', body: { name: 'Test', price: 10,  //image: "https://github.com/Laboratoria/bootcamp/tree/main/projects/04-burger-queen-api/resources/images/water.jpg", 
        type: "Lunch"
      },
    })
      .then((resp) => {
